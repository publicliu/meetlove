Ext.define('Eway.controller.user.User', {
    ...
    init : function(){
   		var me = this;
   		me.control({
   			'user_User org_orgtree' : {
   				itemclick : me.orgTreeItemClick,
   				afterrender : me.orgTreeAfterRender
   			},
   			'user_User button[action=query]' : {
   				click : me.onQuery
   			},
   			'user_User button[action=add]' : {
   				click : me.onAdd
   			},
   			'user_User button[action=update]' : {
   				click : me.onUpdate
   			},
   			'user_User button[action=remove]' : {
   				click : me.onRemove
   			}
   		});
    },
